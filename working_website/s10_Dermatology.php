        ...
        <div class="row">
            <div class="col-md-12">
                <div class="block text-center">
                    <h1 class="text-capitalize mb-5 text-lg">Dermatology</h1>
                </div>
            </div>
        </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="department-content mt-1">
                    ...
                    <p>Our Department of Dermatology provides a comprehensive approach to skincare through dermatologic
                        diagnostic and therapeutic services. Our team of doctors caters to patients with skin problems,
                        such as skin cancers, wound healing, cosmetic dermatology and laser surgery, autoimmune diseases
                        of the skin, psoriasis, acne, eczema, and pigmentation.</p>
                    <p></p>
                    ...
                    <ul class="list-unstyled department-service">
                        <li><i class="icofont-check mr-2"></i>Electro Cauterization</li>
                        <li><i class="icofont-check mr-2"></i>Photo therapy</li>
                        <li><i class="icofont-check mr-2"></i>Cryosurgery</li>
                        <li><i class="icofont-check mr-2"></i>Curetting</li>
                        <li><i class="icofont-check mr-2"></i>Vitilgo Punch</li>
                        <li><i class="icofont-check mr-2"></i>Grafting</li>
                        <li><i class="icofont-check mr-2"></i>Skin Biopsies</li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-4">
