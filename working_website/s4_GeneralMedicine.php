        ...
        <div class="row">
            <div class="col-md-12">
                <div class="block text-center">
                    <h1 class="text-capitalize mb-5 text-lg">General Medicine</h1>
                </div>
            </div>
        </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="department-content mt-1">
                    <h3 class="text-md">General Medicine</h3>
                    <div class="divider my-4"></div>
                    <p>Our Department of General Medicine provides a wide range of clinical services incorporating
                        general internal medicine and its subspecialities, such as gastroenterology, rheumatology, and
