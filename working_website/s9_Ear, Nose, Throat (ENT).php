        ...
        <div class="row">
            <div class="col-md-12">
                <div class="block text-center">
                    <h1 class="text-capitalize mb-5 text-lg">Ear, Nose, Throat (ENT)</h1>
                </div>
            </div>
        </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="department-content mt-1">
                    <h3 class="text-md">Ear, Nose, Throat (ENT)</h3>
                    <div class="divider my-4"></div>
                    <p>Our Department of ENT focuses on studying and treating disorders of the ear, nose, throat, head
                        and neck to patients of all age groups. Our team of doctors is also skilled in the management of
                    ...
                    <ul class="list-unstyled department-service">
                        <li><i class="icofont-check mr-2"></i>Microsurgery of the Ear</li>
                        <li><i class="icofont-check mr-2"></i>Endoscopic Surgery for disease of Nose and sinuses</li>
                        <li><i class="icofont-check mr-2"></i>Endoscopic closure of CSF Rhinorrhoea</li>
                        <li><i class="icofont-check mr-2"></i>TransNasal Endoscopic removal of Pituitary Tumour.</li>
                        <li><i class="icofont-check mr-2"></i>Medical management of all other common ailments
                        </li>
                        <li><i class="icofont-check mr-2"></i>Full range of audiological investigations and
                            rehabilitation including digital hearing aids, balance testing and tinnitus therapy
                        </li>
                    </ul>
                </div>
            </div>
