        ...
        <div class="row">
            <div class="col-md-12">
                <div class="block text-center">
                    <h1 class="text-capitalize mb-5 text-lg">Anaesthesiology</h1>
                </div>
            </div>
        </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="department-content mt-1">
                    <h3 class="text-md">Anaesthesiology</h3>
                    <div class="divider my-4"></div>
                    <p>Our Department of Anesthesia provides various anesthesia services in areas such as
                        post-surgery pain management. Anesthesiology is a specialized medical branch committed to
                        effective pain relief and total perioperative care of patients before, during and after surgery.
                        Our anesthesiologists have an expertise in advanced anesthesiology and pain medicine. Our
                        department is dedicated to providing safe and comprehensive care to patients.</p>
                    <p></p>
                    ...
                    <ul class="list-unstyled department-service">
                        <li><i class="icofont-check mr-2"></i>General Surgery</li>
                        <li><i class="icofont-check mr-2"></i>Orthopedics</li>
                        <li><i class="icofont-check mr-2"></i>Obstetrics and Gynecology</li>
                        <li><i class="icofont-check mr-2"></i>Otolaryngology</li>
                        <li><i class="icofont-check mr-2"></i>Ophthalmology</li>
                        <li><i class="icofont-check mr-2"></i>Maxillofacial surgery</li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-4">
