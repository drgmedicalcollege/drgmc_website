        ...
        <div class="row">
            <div class="col-md-12">
                <div class="block text-center">
                    <h1 class="text-capitalize mb-5 text-lg">Orthopedics</h1>
                </div>
            </div>
        </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="department-content mt-1">
                    ...
                    <p>Our Department of Orthopedics offers a wide range of medical and surgical treatments for bone and
                        joint injuries and diseases. Our comprehensive team of specialists is devoted to helping
                        patients with complex orthopedic conditions.
                    </p>
                    <p></p>
                    ...
                    <ul class="list-unstyled department-service">
                        ...
                        <li><i class="icofont-check mr-2"></i>Hip Replacement Surgery</li>
                        <li><i class="icofont-check mr-2"></i>Knee Replacement Surgery</li>
                        <li><i class="icofont-check mr-2"></i>Elbow Replacement</li>
                        <li><i class="icofont-check mr-2"></i>Shoulder Replacement Surgery</li>
                        <li><i class="icofont-check mr-2"></i>Replacement of other joints (eg. wrist joints & big toe
                            joint)
                        </li>
                        <li><i class="icofont-check mr-2"></i>Arthroscopic Surgeries of Knees and Shoulder joints</li>
                        <li><i class="icofont-check mr-2"></i>Ligament reconstructions</li>
                        <li><i class="icofont-check mr-2"></i>Spine surgery (disc, infection, trauma and other
                            deformities)
                        </li>
                        <li><i class="icofont-check mr-2"></i>Paediatric orthoapedics surgeries</li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-4">
