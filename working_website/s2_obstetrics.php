        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="department-content mt-1">
                    <h3 class="text-md">Obstetrics & Gynecology</h3>
                    <div class="divider my-4"></div>
                    <p>Our Obstetrics & gynecology department aims to provide high quality health care for women. Our
                        doctors possess advanced knowledge, skills and capability in areas such as antenatal and
                        postnatal care, infertility, and oncology.</p>
                    <p></p>
