            ...
            <div class="col-lg-8">
                <div class="department-content mt-1">
                    ...
                    <ul class="list-unstyled department-service">
                        ...
                        <li><i class="icofont-check mr-2"></i>Bronchoscopy services</li>
                        <li><i class="icofont-check mr-2"></i>Transbronchial lung biopsy</li>
                        <li><i class="icofont-check mr-2"></i>Allergy testing and Immunotherapy.</li>
                        <li><i class="icofont-check mr-2"></i>Sleep study</li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-4">
