        ...
        <div class="row">
            <div class="col-md-12">
                <div class="block text-center">
                    <h1 class="text-capitalize mb-5 text-lg">Cardiology</h1>
                </div>
            </div>
        </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="department-content mt-1">
                    ...
                    <p>Our Department of Cardiology understands the stress caused to patients and their families due to
                        various heart conditions. Our cardiology doctors are determined to work collaboratively with
                        patients to come up with the best treatment option. We offer a wide range of services from early
                        disease detection and diagnosis to interventions.</p>
                    <p></p>
                    ...
                    <ul class="list-unstyled department-service">
                        ...
                        <li><i class="icofont-check mr-2"></i>Stress Testing</li>
                        <li><i class="icofont-check mr-2"></i>Holter Monitoring</li>
                        <li><i class="icofont-check mr-2"></i>Contrast Echo Cardiography</li>
                        <li><i class="icofont-check mr-2"></i>Dobutamin Stress Test</li>
                        <li><i class="icofont-check mr-2"></i>Coronory Angiography</li>
                        <li><i class="icofont-check mr-2"></i>Coronory Angioplasty</li>
                        <li><i class="icofont-check mr-2"></i>Paces Maker Implantation (Temporaty / Permantant)</li>
