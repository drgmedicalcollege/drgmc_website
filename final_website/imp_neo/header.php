                            ...
                            <div class="row">
                                <div class="col pl-0">
                                    <ul class="list-style-none">
                                        <li><a class="dropdown-item" href="#">Anesthesia & Pain Management</a></li>
                                        <li><a class="dropdown-item" href="#">Centre for Digestive and Liver
                                                Diseases</a></li>
                                        <li><a class="dropdown-item" href="#">Centre for Neurosciences</a></li>
                                        <li><a class="dropdown-item" href="#">Centre for Orthopaedics
                                                and Joint</a></li>
                                        <li><a class="dropdown-item" href="#">Centre for Renal Sciences</a></li>
                                        <li><a class="dropdown-item" href="#">Clinical Nutrition & Diabetics</a>
                                        <li><a class="dropdown-item" href="#">Critical Care</a>
                                        <li><a class="dropdown-item" href="#">Dermatology</a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="col pl-0">
                                    <ul class="list-style-none">
                                        <li><a class="dropdown-item" href="#">Endocrinology and Endocrine Surgery</a>
                                        <li><a class="dropdown-item" href="#">ENT</a>
                                        <li><a class="dropdown-item" href="#">General Surgery</a>
                                        <li><a class="dropdown-item" href="#">Heart Centre</a>
                                        <li><a class="dropdown-item" href="#">Internal Medicine</a>
                                        <li><a class="dropdown-item" href="#">Laboratory Medicine</a>
                                        <li><a class="dropdown-item" href="#">Obstetrics and Gynaecology</a>
                                        <li><a class="dropdown-item" href="#">Ophthalmology</a>
                                    </ul>
                                </div>
                                <div class="col pl-0">
                                    <ul class="list-style-none">
                                        <li><a class="dropdown-item" href="#">Oral & Maxillofacial Surgery &
                                                Head & Neck Oncology</a>
                                        <li><a class="dropdown-item" href="#">Pediatrics & Neonatology</a>
                                        <li><a class="dropdown-item" href="#">Physiotherapy &
                                                Rehabilitation Centre</a>
                                        <li><a class="dropdown-item" href="#">Plastic, Reconstruction &
                                                Aesthetic Surgery</a>
                                        <li><a class="dropdown-item" href="#">Pulmonary Medicine</a>
                                        <li><a class="dropdown-item" href="#">Radio-Diagnosis &
                                                Imaging Centre</a>
                                        <li><a class="dropdown-item" href="#">Transfusion Medicine &
                                                Blood Bank</a>
                                        <li><a class="dropdown-item" href="#">Dept. Of Neurosurgery</a>
