        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-lg-8 text-center">
                    <h1 class="display-2 mb-4">We are DRG</h1>
                    <h1 class="display-2 mb-4">Multispeciality Hospital</h1>
                    <p class="lead mb-5">We care for our patients all the time</p>
                    <a class="btn btn-primary" href="contact.html"><span class="fas fa-book-reader mr-2"></span>Our
                        works</a></div>
            </div>
        </div>
    </div>
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-4 px-md-0 mb-4 mb-lg-0">
                                <div class="card-body text-center bg-primary py-5">
                                    ...
                                    <!-- Text -->
                                    <p class="mb-0">At Themesberg, we use human, brand, and cultural insights to unlock
                                        strategic business opportunities for clients.</p>
                                </div>
                            </div>
                            <div class="col-12 col-lg-4 px-md-0 mb-4 mb-lg-0">
                                <div class="card-body text-center bg-primary py-5">
                                    ...
                                    <!-- Text -->
                                    <p class="mb-0">Despite being cautioned not to judge a book by its cover, we all do
                                        it every day. We making your site looks better.</p>
                                </div>
                            </div>
        ...
        <div class="container">
            <div class="row align-items-center justify-content-around">
                ...
                <div class="col-md-6 col-xl-5 text-center text-md-left">
                    ...
                    <p class="lead">Our small team is active in the creative community, endlessly interested in what’s
                        next, and generally pleasant to be around.</p>
                </div>
            </div>
        </div>
    </section>
